##########################################################################################
# Name:        opstestfw.switch.CLI.ShowLldpNeighborInfo
#
# Namespace:   opstestfw.switch.CLI
#
...
def ShowLldpNeighborInfo(**kwargs):
    ...
    #returnStructure = opstestfw.switch.CLI.VtyshShell(connection = connection,configOption="unconfig")
