##########################################################################################
# Name:        opstestfw.switch.CLI.LAG.InterfaceLacpAggKeyConfig
#
...
def InterfaceLacpAggKeyConfig(**kwargs):
    ...
    if retCode != 0:
        opstestfw.LogOutput('error', "Failed to configure the aggregation-key to the interface" + str(interface))
    else:
        opstestfw.LogOutput('debug', "Aggregation-key assigned" + str(interface))   
