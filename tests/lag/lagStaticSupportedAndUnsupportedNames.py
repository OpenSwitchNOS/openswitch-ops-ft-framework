...
def configureLag(dut01Obj, lagName, negative):
    ...
    retStruct = lagCreation(deviceObj=dut01Obj, lagId=lagName, configFlag=True)
...
class Test_lagStaticSupportedAndUnsupportedNames:
    ...
    def setup_class(cls):
        ...
        Test_lagStaticSupportedAndUnsupportedNames.testObj = testEnviron(topoDict=topoDict)
        Test_lagStaticSupportedAndUnsupportedNames.topoObj = Test_lagStaticSupportedAndUnsupportedNames.testObj.topoObjGet()
        # Global variables
        global dut01Obj 
